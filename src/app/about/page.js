...
const About = () => {
  ...
  <div className="max-w-screen-md mx-auto text-center">
    ...
    <p className="mt-10 lg:mt-10 text-lg">Yogdaan is more than just a charity donation platform; it's a beacon of hope and a catalyst for positive change. Founded on the principles of transparency, empathy, and community empowerment, we strive to connect passionate donors with impactful projects around the globe. At Yogdaan, we believe in the power of collective action and the transformative potential of small acts of kindness. Our platform offers a seamless and secure way for individuals to contribute to causes they care about deeply, knowing that their donations will directly benefit those in need. We're not just facilitating transactions; we're building bridges between hearts and communities, fostering a sense of belonging and shared responsibility for a brighter future.</p>
  </div>
